    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/procedimentos{id}").hasAnyRole("ADMINISTRADOR", "ASSISTENTE_ADMINISTRATIVO")
                        ...
                        .requestMatchers(HttpMethod.GET, "/procedimentos-paciente/paciente/cpf/{cpf}").hasAnyRole("ADMINISTRADOR", "ASSISTENTE_ADMINISTRATIVO")
