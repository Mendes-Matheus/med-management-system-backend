    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PUT, "/estabelecimentos/{id}").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/pacientes/{id}").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/procedimentos/{id}").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/procedimentos-paciente/{id}").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/auth/users/{id}").permitAll()
